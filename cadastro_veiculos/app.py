...
from cadastro_veiculos.rotas import v1
from cadastro_veiculos.arquivos import html_desc
from cadastro_veiculos.rotas.v1 import doc_sphinx
...
def load_exceptions(app: FastAPI):
    @app.exception_handler(CadastroVeiculosException)
    async def cadastro_veiculos_exception_handler(
        request: Request, exception: CadastroVeiculosException
    ):  # pragma: no cover
        return JSONResponse(
